...
class Vonage::ProactiveConnect::ListTest < Vonage::Test
  ...
  def test_update_method
    ...
    assert_kind_of Vonage::Response, list.update(id: list_id, name: "Test List Updated")
  end
  ...
  def test_update_method_with_optional_params
    ...
    assert_kind_of Vonage::Response, list.update(id: list_id, name: "Test List Updated", description: "qux", tags: ["quux", "xyzzy"])
  end

  def test_update_method_without_id
    assert_raises(ArgumentError) { list.update(name: "Test List Updated") }
  end

  def test_update_method_without_name
    assert_raises(ArgumentError) { list.update(id: list_id) }
  end
  ...
  def test_fetch_and_replace_items_method
    ...
    assert_kind_of Vonage::Response, list.fetch_and_replace_items(id: list_id)
  end

  def test_fetch_and_replace_items_method_without_id
    assert_raises(ArgumentError) { list.fetch_and_replace_items }
  end
end
