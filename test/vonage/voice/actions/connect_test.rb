...
class Vonage::Voice::Actions::ConnectTest < Vonage::Test
  ...
  def test_verify_endpoint_with_invalid_from_number
  ...
  def verify_endpoint_with_invalid_event_type
  ...
  def verify_endpoint_with_invalid_limit
  ...
  def verify_endpoint_with_invalid_machine_detection
  ...
  def verify_endpoint_with_invalid_event_url
  ...
  def verify_endpoint_with_invalid_event_method
  ...
  def verify_endpoint_with_invalid_ringback_tone
