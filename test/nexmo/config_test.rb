...
class Nexmo::ConfigTest < Nexmo::Test
  ...
  def test_api_key_method_raises_authentication_error
    config = Nexmo::Config.new

    exception = assert_raises(Nexmo::AuthenticationError) { config.api_key }
  ...
  def test_api_secret_method_raises_authentication_error
    ...
    exception = assert_raises(Nexmo::AuthenticationError) { config.api_secret }
  ...
  def test_application_id_method_raises_authentication_error
    ...
    exception = assert_raises(Nexmo::AuthenticationError) { config.application_id }
  ...
  def test_private_key_method_raises_authentication_error
    ...
    exception = assert_raises(Nexmo::AuthenticationError) { config.private_key }
  ...
  def test_signature_secret_method_raises_authentication_error
    ...
    exception = assert_raises(Nexmo::AuthenticationError) { config.signature_secret }
